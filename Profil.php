...
require './PHP_Bausteine/controller/NutzerController.php';
...
$beigetreteneTreffen = $nutzerController->beigetreteneTreffenNutzer();
$erstellteTreffen = $nutzerController->erstellteTreffenNutzer();
?>
    <body>
<?php
